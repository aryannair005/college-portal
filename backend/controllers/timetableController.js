...
exports.toggleTimetableStatus = async (req, res) => {
    try {
        ...
        req.session.messages = [`Timetable ${timetable.isActive ? 'activated' : 'deactivated'} successfully`];
        res.redirect('/admin/timetable');
    } catch (error) {
...
exports.copyTimetable = async (req, res) => {
    try {
        ...
        req.session.messages = ['Timetable copied successfully. Please edit and activate it.'];
