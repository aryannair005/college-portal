...
const PREDEFINED_RESPONSES = {
  "how to login":
    'To login, click the "Login" button in the navigation bar, enter your username and password. Students can register for new accounts, while admins need a special creation page.',
  "how to register":
    'Click "Register" in the navigation bar to create a new student account. You\'ll need to provide a username, email, and password.',
  "how to upload resources":
    "Only administrators can upload resources. Go to Admin Dashboard → Add Resource, fill in the details, and upload a PDF or provide an external link.",
  "how to post doubt":
    'Go to "Doubts & Discussion" from the navigation menu, click "Post Your Doubt", fill in the title, description, course details, and optionally attach an image.',
  "how to update profile":
    'Click on your username in the top-right corner → "My Profile" → "Edit Profile" to update your personal information and profile picture.',
  "admin access":
    "To create an admin account, go to /create-admin and use the secret code. Contact the system administrator for the secret code.",
  "download files":
    "You can download resources and PYQs by clicking the download button on the respective cards. PDFs can also be viewed inline.",
  "notice board":
    'Check the "Notices" section in the navigation menu to view important announcements from administrators.',
  "view timetable":
    'Click "Timetable" in the navigation menu to view class schedules. You can filter by course, semester, and section to find your specific timetable.',
  "check timetable":
    'Go to the "Timetable" section from the navigation bar. Use the filters to select your course, semester, and section to view your class schedule with timings, subjects, and faculty details.',
  timetable:
    "The Timetable section shows your class schedules with daily timings, subjects, faculty names, and room details. Filter by course, semester, and section to find your specific schedule.",
  "class schedule":
    'Your class schedule is available in the "Timetable" section. Filter by your course, semester, and section to see daily class timings, subjects, and faculty information.',
  calendar:
    'Click "Calendar" in the navigation menu to view academic events, important dates, holidays, and exam schedules in a calendar format.',
  "academic calendar":
    'The Academic Calendar shows important dates like exams, holidays, and academic deadlines. Access it through the "Calendar" link in the navigation menu.',
  events:
    'Check the "Calendar" section to view all academic events, including exam dates, holidays, and important academic deadlines.',
  "manage timetable":
    "Admins can manage timetables by going to Admin Dashboard → Manage Timetables. You can create, edit, copy, activate/deactivate, and delete timetables for different courses.",
  "add timetable":
    "Admins can add new timetables by going to Admin Dashboard → Add Timetable. Fill in course details, semester, section, academic year, and create the weekly schedule.",
  "manage calendar":
    "Admins can manage calendar events by going to Admin Dashboard → Manage Calendar. You can add, edit, and delete academic events and important dates.",
  "add event":
    "Admins can add calendar events by going to Admin Dashboard → Add Event. Include event title, description, date, and category information.",
};
...
exports.getChatbotPage = (req, res) => {
  res.render("chatbot", {
    ...
    initialMessage:
      "Hi! I'm here to help you navigate the College Portal. Ask me about website features, how to use different sections, view timetables, check calendar events, or any navigation questions!",
  });
};
  ...
  try {
    ...
    if (isAcademicQuestion(userMessage)) {
      return res.json({
        success: true,
        response:
          'I can only help with website-related questions. For academic doubts and subject help, please use the "Doubts & Discussion" section where you can post your questions and get help from other students and teachers.',
      });
    }
