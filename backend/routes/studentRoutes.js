...
// Resources
router.get('/resources', ensureStudent, validate('studentQuerySchema', 'query'), studentController.getResources);
...
// PYQs
router.get('/pyqs', ensureStudent, validate('studentQuerySchema', 'query'), studentController.getPyqs);
...
// Syllabus
router.get('/syllabus', ensureStudent, validate('studentQuerySchema', 'query'), studentController.getSyllabus);
...
router.get('/timetable', ensureStudent, require('../controllers/timetableController').getTimetablePage);
router.get('/timetable/:id', ensureStudent, require('../controllers/timetableController').getTimetableDetail);
